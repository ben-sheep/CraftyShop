                            ...
                            <div class="register-box">
                                ...
                                <form class="form form--login" method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="form__group mb--20">
                                        <label class="form__label form__label--2" for="first_name">First Name <span
                                                class="required">*</span></label>
                                        <input id="first_name" type="first_name" class="form__input form__input--3 @error('first_name') is-invalid @enderror" first_name="first_name" value="{{ old('first_name') }}" autocomplete="first_name">
                                    ...
                                    <div class="form__group mb--20">
                                        <label class="form__label form__label--2" for="last_name">Last Name <span
                                                class="required">*</span></label>
                                        <input id="last_name" type="last_name" class="form__input form__input--3 @error('last_name') is-invalid @enderror" last_name="last_name" value="{{ old('last_name') }}" autocomplete="last_name">
